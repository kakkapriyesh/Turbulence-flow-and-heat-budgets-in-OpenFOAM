...
(
    ...
    mesh,
      ...
      (
           "MD1Mean", 
           (dimVelocity*dimTemperature)/(dimLength),
           tensor::zero
      )
);
...
(
    ...
    dimensionedScalar("MD1Tux",(dimVelocity*dimTemperature)/(dimLength),0)
...
dimensionedScalar("MDu",(dimTemperature)/(dimTime*dimLength),0)
  ...
  #include "createPhi.H"  
   ...
   Dut= GradTUPMean.component(0);
   Dvt= GradTUPMean.component(1);
   Dwt= GradTUPMean.component(2);
...
//Info<< "    Calculating T diffusion ut1" << endl;
...
MDu = (MD1Tuy.component(1)+MD1Tuz.component(2))+(MD2utx.component(0)+MD2uty.component(1)+MD2utz.component(2));
